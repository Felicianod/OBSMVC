...
{
    public class ColFormTemplateControllerFD1 : Controller
    {
        private DSC_OBS_DB_ENTITY db = new DSC_OBS_DB_ENTITY();


        [HttpGet]
        public ActionResult showColFormTemplate1(int id)
        {
            CollectionForm selectedColForm1 = new CollectionForm(id);
            return View(selectedColForm1);            
        }
    }
